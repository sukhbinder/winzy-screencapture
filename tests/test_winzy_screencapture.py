...
@patch('winzy_screencapture.get_filename_as_current_time', return_value="mock_filename.png")
def test_screen_method(mock_get_filename, mock_get_screenimage):
    ...
    mock_get_screenimage.assert_called_once_with(os.path.join("/tmp", "mock_filename.png"))
